...
<div class="progress">
    ...
    <div class="progress-bar progress-bar-info" title=".progress-bar.progress-bar-info" style="width: 15%;"></div>
    <div class="progress-bar progress-bar-warning" title=".progress-bar.progress-bar-warning" style="width: 15%;"></div>
